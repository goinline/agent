...
func (p *runtimeBlock) Serialize() ([]byte, error) {
	...
	ret[2] = metricValue("GC/NULL/Count", &p.NumGC)
	ret[3] = metricValue("GC/NULL/Time", &p.GCTime)
	ret[4] = metricValue("CPU/NULL/UserTime", &p.UserTime)
	ret[5] = metricValue("CPU/NULL/UserUtilization", &p.UserUtilization)
	ret[6] = metricValue("Memory/NULL/PhysicalUsed", &p.mem)
	ret[7] = metricValue("Memory/NULL/VmSize", &p.VMPeakSize)
	ret[8] = metricValue("Memory/NULL/VmRSS", &p.RssPeak)
	ret[9] = metricValue("Memory/NULL/MemSys", &p.MemTotalSys)
	ret[10] = metricValue("Memory/Stack/StackSys", &p.MemStackSys)
	ret[11] = metricValue("Memory/MSpan/MSpanSys", &p.MSpanSys)
	ret[12] = metricValue("Memory/MCache/MCacheSys", &p.MCacheSys)
	ret[13] = metricValue("Memory/Heap/HeapSys", &p.MemHeapSys)
	ret[14] = metricValue("Memory/NULL/BuckHashSys", &p.BuckHashSys)
	ret[15] = metricValue("Memory/Heap/HeapInuse", &p.HeapInuse)
	ret[16] = metricValue("Memory/Stack/StackInuse", &p.StackInuse)
	ret[17] = metricValue("Memory/MSpan/MSpanInuse", &p.MSpanInuse)
	ret[18] = metricValue("Memory/MCache/MCacheInuse", &p.MCacheInuse)
	ret[19] = metricValue("GoRuntime/NULL/Frees", &p.Frees)
	ret[20] = metricValue("GoRuntime/NULL/Mallocs", &p.Mallocs)
	ret[21] = metricValue("GoRuntime/NULL/Lookups", &p.Lookups)
